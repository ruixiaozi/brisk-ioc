...
const BeanOption_1 = require("../entity/option/BeanOption");
const InitOption_1 = require("../entity/option/InitOption");
/**
 * 初始化生命周期 装饰器工厂
...
function Init(option) {
    if (!option)
        option = new InitOption_1.InitOption();
...
function Bean(option) {
    if (!option)
        option = new BeanOption_1.BeanOption();
    return new DecoratorFactory_1.DecoratorFactory()
